...
namespace Ludix.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ReviewsController(LudixContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ReviewId,Rating,ReviewText,ReviewDate,UserId,GameId")] Review review)
        {
